...
<head>
    ...
    {{--<script src="https://cdn.tailwindcss.com"></script> we added Tailwind in Vite, we don't need CDN any more--}}
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            {{--show only if user not logged in, you can also use @auth directive to show only if logged in --}}
                            @guest
